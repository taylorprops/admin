...
namespace App\Http\Controllers\TextEditor;
...
class FileUploadController extends Controller {
    ...
    public function file_upload(Request $request) {
         ...
         ***************************************************/
        $accepted_origins = array(config('app.url'));
        ...
        if (is_uploaded_file($temp['tmp_name'])) {
            ...
            */
            ...
            // Verify extension
            if (!in_array(strtolower(pathinfo($temp['name'], PATHINFO_EXTENSION)), array("gif", "jpg", "jpeg", "JPG", "png"))) {
