    ...
    $(function() {
        ...
        $('.sortable').sortable({
            ...
            stop: function (event, ui) {
                ...
                axios.post('/admin/resources/reorder', formData, axios_options)
...
function show_add_resource(ele) {
    ...
    save_button.off('click').on('click', function () {
        ...
        if (validate == 'yes') {
            ...
            axios.post('/admin/resources/add', formData, axios_options)
                .then(function (response) {
                    cancel_button.trigger('click');
                    toastr['success']('Resource Added Successfully');
                    let resource_id = response.data;
                    let new_resource_html = added_item_html(resource_id, resource_type, resource_name, resource_state, resource_color);
...
function save_edit_resource(ele, resource_input, resource_state_select, resource_input_color, list_group_item, resource_div, resource_type) {
    ...
    if (validate == 'yes') {
        ...
        axios.post('/admin/resources/edit', formData, axios_options)
            .then(function (response) {
...
function delete_deactivate_resource_resource(ele, action) {
    ...
    axios.post('/admin/resources/delete_deactivate', formData, axios_options)
        .then(function (response) {
