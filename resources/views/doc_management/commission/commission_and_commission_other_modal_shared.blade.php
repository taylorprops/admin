                ...
                <form id="edit_check_out_form">
                    ...
                    <div class="p-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <input type="text" class="custom-form-element form-input date-field required" name="edit_check_out_date" id="edit_check_out_date" data-label="Date On Check">
                            </div>
                            <div class="col-12 col-sm-6 col-lg-4">
                        ...
                        <div class="row mb-3 mt-3">
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <input type="text" class="custom-form-element form-input date-field" id="edit_check_out_date_ready" name="edit_check_out_date_ready" data-label="Date Ready">
                            </div>
                        </div>
                ...
                <form id="edit_queue_check_form">
                    ...
                    <div class="animate__animated">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <input type="date" class="custom-form-element form-input date-field required" name="edit_queue_check_date" id="edit_queue_check_date" data-label="Date On Check">
                            </div>
                            <div class="col-12 col-sm-6 col-lg-4">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <input type="date" class="custom-form-element form-input date-field required" name="edit_queue_check_date_received" id="edit_queue_check_date_received" value="{{ date('Y-m-d') }}" data-label="Date Received">
                            </div>
                            <div class="col-12 col-sm-6 col-lg-4">
                                <input type="date" class="custom-form-element form-input date-field" name="edit_queue_check_date_deposited" id="edit_queue_check_date_deposited" data-label="Date Deposited">
                            </div>
                        </div>
