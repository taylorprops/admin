    ...
    <div class="row">
        ...
        <div class="col-12">
            ...
            <div class="no-wrap">
                ...
                <table id="contracts_table" class="table table-hover table-sm missing-transactions-table" width="100%">
                    ...
                    <tbody>
                        ...
                        @foreach($properties as $property)
                            ...
                            @php
                                $agent_name = $property -> agent ? $property -> agent -> full_name : $property -> BuyerAgentFirstName.' '.$property -> BuyerAgentLastName;
                                $agent_phone = $property -> agent ? $property -> agent -> cell_phone : $property -> BuyerAgentPreferredPhone;
                                $agent_email = $property -> agent ? $property -> agent -> email : $property -> BuyerAgentEmail;
                            ...
                            <tr>
                                ...
                                <td data-sort="{{ $property -> PurchaseContractDate }}">
                                    {{ date_mdy($property -> PurchaseContractDate) }}
                                    <br>
