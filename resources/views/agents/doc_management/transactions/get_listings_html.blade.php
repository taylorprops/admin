    ...
    <tbody>
        @foreach($transactions as $transaction)
            ...
            if($contract) {
                ...
                if(stristr($status, 'Under Contract')) {
                    $status .= ' - <a href="/agents/doc_management/transactions/transaction_details/'.$contract -> Contract_ID.'/contract">View</a><br><span class="text-gray font-8">Closes: '.date_mdy($close_date).'</span>';
                }
            }
